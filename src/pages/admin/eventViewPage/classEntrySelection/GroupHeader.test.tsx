...
describe('GroupHeader', () => {
  ...
  it('renders with the correct date and time', () => {
    ...
    expect(screen.getByText('eeeeee d.M. registration.timeLong.ap')).toBeInTheDocument()
  })
  ...
  it('renders with the correct styling', () => {
    ...
    const header = screen.getByText('eeeeee d.M. registration.timeLong.ap').closest('.header')
  ...
  it('renders with afternoon time', () => {
    ...
    expect(screen.getByText('eeeeee d.M. registration.timeLong.ip')).toBeInTheDocument()
  })
})
