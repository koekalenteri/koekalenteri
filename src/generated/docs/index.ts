...
import shot18 from "../../pages/admin/eventViewPage/infoPanel/__screenshots__/StartNumbersPublishing.visual.test.tsx/start-numbers-publishing-two-days-chromium-linux.png"
import shot19 from "../../pages/admin/eventViewPage/infoPanel/__screenshots__/StartNumbersPublishing.visual.test.tsx/start-numbers-publishing-half-day-chromium-linux.png"
import shot20 from "../../pages/admin/eventViewPage/__screenshots__/MessageRecipientsDialog.visual.test.tsx/message-recipients-chromium-linux.png"
import shot21 from "../../pages/__screenshots__/PaymentPage.visual.test.tsx/payment-page-methods-desktop-chromium-linux.png"
import shot22 from "../../pages/admin/eventViewPage/infoPanel/__screenshots__/ResultsPublishing.visual.test.tsx/results-publishing-chromium-linux.png"
import shot23 from "../../pages/admin/eventStartNumbersPage/__screenshots__/StartNumbersEntry.visual.test.tsx/start-numbers-entry-class-link-chromium-linux.png"
import shot24 from "../../pages/admin/eventResultsPage/__screenshots__/ResultsTable.visual.test.tsx/results-entry-nowt-chromium-linux.png"
import shot25 from "../../pages/admin/eventResultsPage/__screenshots__/ResultsTable.visual.test.tsx/results-entry-nou-chromium-linux.png"
import shot26 from "../../pages/components/__screenshots__/SideMenu.visual.test.tsx/side-menu-expanded-chromium-linux.png"
import shot27 from "../../pages/admin/__screenshots__/JudgeListPage.visual.test.tsx/judge-list-mock-trial-chromium-linux.png"
import shot28 from "../../pages/components/stats/__screenshots__/CapacityUtilizationChart.visual.test.tsx/capacity-all-classes-chromium-linux.png"
import shot29 from "../../pages/components/stats/__screenshots__/RetentionChart.visual.test.tsx/retention-chromium-linux.png"
  ...
  en: [
    ...
    },
    {
      ...
      html:
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot18 + "\" alt=\"A two-day class publishes its numbers one day at a time\" loading=\"lazy\"><figcaption>A two-day class publishes its numbers one day at a time</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot19 + "\" alt=\"The morning's numbers go out before the afternoon's draw\" loading=\"lazy\"><figcaption>The morning's numbers go out before the afternoon's draw</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot20 + "\" alt=\"The message's recipients are picked class by class\" loading=\"lazy\"><figcaption>The message's recipients are picked class by class</figcaption></figure>",
      order: 30,
    ...
    },
    {
      ...
      html:
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot21 + "\" alt=\"Choosing the payment method before going to Paytrail\" loading=\"lazy\"><figcaption>Choosing the payment method before going to Paytrail</figcaption></figure>" +
    ...
    },
    {
      ...
      html:
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot22 + "\" alt=\"Publishing results per class, with the posts and the entry below\" loading=\"lazy\"><figcaption>Publishing results per class, with the posts and the entry below</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot23 + "\" alt=\"The class secretary's view of their own class\" loading=\"lazy\"><figcaption>The class secretary's view of their own class</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot24 + "\" alt=\"A NOWT class's points per task, the second dog stopped at post 2\" loading=\"lazy\"><figcaption>A NOWT class's points per task, the second dog stopped at post 2</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot25 + "\" alt=\"A NOU trial's results: judge, result and interruption\" loading=\"lazy\"><figcaption>A NOU trial's results: judge, result and interruption</figcaption></figure>" +
    ...
    },
    {
      ...
      html:
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot26 + "\" alt=\"The admin menu\" loading=\"lazy\"><figcaption>The admin menu</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot27 + "\" alt=\"The judge directory\" loading=\"lazy\"><figcaption>The judge directory</figcaption></figure>" +
    ...
    },
    {
      ...
      html:
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot28 + "\" alt=\"Participants and places by month for one event type\" loading=\"lazy\"><figcaption>Participants and places by month for one event type</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot29 + "\" alt=\"New and returning dog-and-handler pairs by year\" loading=\"lazy\"><figcaption>New and returning dog-and-handler pairs by year</figcaption></figure>" +
    ...
    },
    {
      ...
      html:
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot18 + "\" alt=\"Kahden päivän luokan numerot julkaistaan päivä kerrallaan\" loading=\"lazy\"><figcaption>Kahden päivän luokan numerot julkaistaan päivä kerrallaan</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot19 + "\" alt=\"Aamupäivän numerot julkaistaan ennen iltapäivän arvontaa\" loading=\"lazy\"><figcaption>Aamupäivän numerot julkaistaan ennen iltapäivän arvontaa</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot20 + "\" alt=\"Viestin vastaanottajat valitaan luokittain\" loading=\"lazy\"><figcaption>Viestin vastaanottajat valitaan luokittain</figcaption></figure>",
      order: 30,
      path: "secretary/after-entry-closes",
    ...
    },
    {
      ...
      html:
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot21 + "\" alt=\"Maksutavan valinta ennen siirtymistä Paytrailiin\" loading=\"lazy\"><figcaption>Maksutavan valinta ennen siirtymistä Paytrailiin</figcaption></figure>" +
    ...
    },
    {
      ...
      html:
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot22 + "\" alt=\"Tulosten julkaisu luokittain, alla rastit ja tulosten syöttö\" loading=\"lazy\"><figcaption>Tulosten julkaisu luokittain, alla rastit ja tulosten syöttö</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot23 + "\" alt=\"Luokkasihteerin näkymä omaan luokkaansa\" loading=\"lazy\"><figcaption>Luokkasihteerin näkymä omaan luokkaansa</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot24 + "\" alt=\"NOWT-luokan pisteet tehtävittäin, toinen koirakko keskeytetty rastilla 2\" loading=\"lazy\"><figcaption>NOWT-luokan pisteet tehtävittäin, toinen koirakko keskeytetty rastilla 2</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot25 + "\" alt=\"NOU-kokeen tulokset: tuomari, tulos ja keskeytys\" loading=\"lazy\"><figcaption>NOU-kokeen tulokset: tuomari, tulos ja keskeytys</figcaption></figure>" +
    ...
    },
    {
      ...
      html:
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot26 + "\" alt=\"Ylläpidon valikko\" loading=\"lazy\"><figcaption>Ylläpidon valikko</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot27 + "\" alt=\"Tuomariluettelo\" loading=\"lazy\"><figcaption>Tuomariluettelo</figcaption></figure>" +
    ...
    },
    {
      ...
      html:
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot28 + "\" alt=\"Osallistujat ja paikat kuukausittain yhdelle koemuodolle\" loading=\"lazy\"><figcaption>Osallistujat ja paikat kuukausittain yhdelle koemuodolle</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot29 + "\" alt=\"Uudet ja palaavat koirakot vuosittain\" loading=\"lazy\"><figcaption>Uudet ja palaavat koirakot vuosittain</figcaption></figure>" +
