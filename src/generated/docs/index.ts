...
import shot0 from "../../pages/__screenshots__/SearchPage.visual.test.tsx/search-page-full-desktop-en-chromium-linux.png"
import shot1 from "../../pages/components/registrationForm/__screenshots__/DogInfo.visual.test.tsx/dog-info-fetched-en-chromium-linux.png"
import shot2 from "../../pages/components/registrationForm/__screenshots__/EntryInfo.visual.test.tsx/entry-info-with-classes-en-chromium-linux.png"
import shot3 from "../../pages/admin/__screenshots__/EventListPage.visual.test.tsx/event-list-desktop-en-chromium-linux.png"
import shot4 from "../../pages/admin/components/__screenshots__/EventForm.visual.test.tsx/event-form-desktop-en-chromium-linux.png"
import shot5 from "../../pages/admin/eventViewPage/__screenshots__/EventStateStepper.visual.test.tsx/event-state-stepper-en-chromium-linux.png"
import shot6 from "../../pages/registrationListPage/__screenshots__/InfoBox.visual.test.tsx/info-box-part-missing-en-chromium-linux.png"
import shot7 from "../../pages/components/__screenshots__/CancelDialog.visual.test.tsx/cancel-dialog-open-en-chromium-linux.png"
import shot8 from "../../pages/__screenshots__/RegistrationInvitation.visual.test.tsx/registration-invitation-open-en-chromium-linux.png"
import shot9 from "../../pages/admin/eventViewPage/__screenshots__/ClassEntrySelection.visual.test.tsx/class-entry-selection-groups-and-reserve-en-chromium-linux.png"
import shot10 from "../../pages/admin/eventViewPage/__screenshots__/InfoPanel.visual.test.tsx/info-panel-en-chromium-linux.png"
import shot11 from "../../pages/admin/eventViewPage/__screenshots__/RefundDialog.visual.test.tsx/refund-dialog-open-en-chromium-linux.png"
import shot12 from "../../pages/startListPage/__screenshots__/RegistrationDetails.visual.test.tsx/start-list-result-en-chromium-linux.png"
import shot13 from "../../pages/admin/eventViewPage/__screenshots__/SendMessageDialog.visual.test.tsx/send-message-dialog-open-en-chromium-linux.png"
import shot14 from "../../pages/admin/eventViewPage/infoPanel/__screenshots__/InvitationDelivery.visual.test.tsx/invitation-delivery-en-chromium-linux.png"
import shot15 from "../../pages/admin/eventViewPage/infoPanel/__screenshots__/StartListPublishing.visual.test.tsx/start-list-publishing-en-chromium-linux.png"
import shot16 from "../../pages/admin/startListPage/__screenshots__/StartListGroup.visual.test.tsx/startlist-secretary-group-en-chromium-linux.png"
import shot17 from "../../pages/admin/eventStartNumbersPage/__screenshots__/StartNumbersEntry.visual.test.tsx/start-numbers-entry-secretary-en-chromium-linux.png"
import shot18 from "../../pages/admin/eventStartNumbersPage/__screenshots__/StartNumbersEntry.visual.test.tsx/start-numbers-entry-links-en-chromium-linux.png"
import shot19 from "../../pages/admin/eventViewPage/infoPanel/__screenshots__/StartNumbersPublishing.visual.test.tsx/start-numbers-publishing-two-days-en-chromium-linux.png"
import shot20 from "../../pages/admin/eventViewPage/infoPanel/__screenshots__/StartNumbersPublishing.visual.test.tsx/start-numbers-publishing-half-day-en-chromium-linux.png"
import shot21 from "../../pages/admin/eventViewPage/__screenshots__/MessageRecipientsDialog.visual.test.tsx/message-recipients-en-chromium-linux.png"
import shot22 from "../../pages/__screenshots__/PaymentPage.visual.test.tsx/payment-page-methods-desktop-en-chromium-linux.png"
import shot23 from "../../pages/admin/eventViewPage/infoPanel/__screenshots__/ResultsPublishing.visual.test.tsx/results-publishing-en-chromium-linux.png"
import shot24 from "../../pages/admin/eventStartNumbersPage/__screenshots__/StartNumbersEntry.visual.test.tsx/start-numbers-entry-class-link-en-chromium-linux.png"
import shot25 from "../../pages/admin/eventResultsPage/__screenshots__/ResultsTable.visual.test.tsx/results-entry-nowt-en-chromium-linux.png"
import shot26 from "../../pages/admin/eventResultsPage/__screenshots__/ResultsTable.visual.test.tsx/results-entry-nou-en-chromium-linux.png"
import shot27 from "../../pages/components/__screenshots__/SideMenu.visual.test.tsx/side-menu-expanded-en-chromium-linux.png"
import shot28 from "../../pages/admin/__screenshots__/JudgeListPage.visual.test.tsx/judge-list-mock-trial-en-chromium-linux.png"
import shot29 from "../../pages/components/stats/__screenshots__/CapacityUtilizationChart.visual.test.tsx/capacity-all-classes-en-chromium-linux.png"
import shot30 from "../../pages/components/stats/__screenshots__/RetentionChart.visual.test.tsx/retention-en-chromium-linux.png"
import shot31 from "../../pages/__screenshots__/SearchPage.visual.test.tsx/search-page-full-desktop-chromium-linux.png"
import shot32 from "../../pages/components/registrationForm/__screenshots__/DogInfo.visual.test.tsx/dog-info-fetched-chromium-linux.png"
import shot33 from "../../pages/components/registrationForm/__screenshots__/EntryInfo.visual.test.tsx/entry-info-with-classes-chromium-linux.png"
import shot34 from "../../pages/admin/__screenshots__/EventListPage.visual.test.tsx/event-list-desktop-chromium-linux.png"
import shot35 from "../../pages/admin/components/__screenshots__/EventForm.visual.test.tsx/event-form-desktop-chromium-linux.png"
import shot36 from "../../pages/admin/eventViewPage/__screenshots__/EventStateStepper.visual.test.tsx/event-state-stepper-chromium-linux.png"
import shot37 from "../../pages/registrationListPage/__screenshots__/InfoBox.visual.test.tsx/info-box-part-missing-chromium-linux.png"
import shot38 from "../../pages/components/__screenshots__/CancelDialog.visual.test.tsx/cancel-dialog-open-chromium-linux.png"
import shot39 from "../../pages/__screenshots__/RegistrationInvitation.visual.test.tsx/registration-invitation-open-chromium-linux.png"
import shot40 from "../../pages/admin/eventViewPage/__screenshots__/ClassEntrySelection.visual.test.tsx/class-entry-selection-groups-and-reserve-chromium-linux.png"
import shot41 from "../../pages/admin/eventViewPage/__screenshots__/InfoPanel.visual.test.tsx/info-panel-chromium-linux.png"
import shot42 from "../../pages/admin/eventViewPage/__screenshots__/RefundDialog.visual.test.tsx/refund-dialog-open-chromium-linux.png"
import shot43 from "../../pages/startListPage/__screenshots__/RegistrationDetails.visual.test.tsx/start-list-result-chromium-linux.png"
import shot44 from "../../pages/admin/eventViewPage/__screenshots__/SendMessageDialog.visual.test.tsx/send-message-dialog-open-chromium-linux.png"
import shot45 from "../../pages/admin/eventViewPage/infoPanel/__screenshots__/InvitationDelivery.visual.test.tsx/invitation-delivery-chromium-linux.png"
import shot46 from "../../pages/admin/eventViewPage/infoPanel/__screenshots__/StartListPublishing.visual.test.tsx/start-list-publishing-chromium-linux.png"
import shot47 from "../../pages/admin/startListPage/__screenshots__/StartListGroup.visual.test.tsx/startlist-secretary-group-chromium-linux.png"
import shot48 from "../../pages/admin/eventStartNumbersPage/__screenshots__/StartNumbersEntry.visual.test.tsx/start-numbers-entry-secretary-chromium-linux.png"
import shot49 from "../../pages/admin/eventStartNumbersPage/__screenshots__/StartNumbersEntry.visual.test.tsx/start-numbers-entry-links-chromium-linux.png"
import shot50 from "../../pages/admin/eventViewPage/infoPanel/__screenshots__/StartNumbersPublishing.visual.test.tsx/start-numbers-publishing-two-days-chromium-linux.png"
import shot51 from "../../pages/admin/eventViewPage/infoPanel/__screenshots__/StartNumbersPublishing.visual.test.tsx/start-numbers-publishing-half-day-chromium-linux.png"
import shot52 from "../../pages/admin/eventViewPage/__screenshots__/MessageRecipientsDialog.visual.test.tsx/message-recipients-chromium-linux.png"
import shot53 from "../../pages/__screenshots__/PaymentPage.visual.test.tsx/payment-page-methods-desktop-chromium-linux.png"
import shot54 from "../../pages/admin/eventViewPage/infoPanel/__screenshots__/ResultsPublishing.visual.test.tsx/results-publishing-chromium-linux.png"
import shot55 from "../../pages/admin/eventStartNumbersPage/__screenshots__/StartNumbersEntry.visual.test.tsx/start-numbers-entry-class-link-chromium-linux.png"
import shot56 from "../../pages/admin/eventResultsPage/__screenshots__/ResultsTable.visual.test.tsx/results-entry-nowt-chromium-linux.png"
import shot57 from "../../pages/admin/eventResultsPage/__screenshots__/ResultsTable.visual.test.tsx/results-entry-nou-chromium-linux.png"
import shot58 from "../../pages/components/__screenshots__/SideMenu.visual.test.tsx/side-menu-expanded-chromium-linux.png"
import shot59 from "../../pages/admin/__screenshots__/JudgeListPage.visual.test.tsx/judge-list-mock-trial-chromium-linux.png"
import shot60 from "../../pages/components/stats/__screenshots__/CapacityUtilizationChart.visual.test.tsx/capacity-all-classes-chromium-linux.png"
import shot61 from "../../pages/components/stats/__screenshots__/RetentionChart.visual.test.tsx/retention-chromium-linux.png"
...
export const docsPages: Readonly<Record<string, readonly DocsPage[]>> = {
  en: [
    ...
    },
    {
      ...
      order: 10,
      path: "secretary/before-entry-opens",
      title: "Before entry opens",
    },
    {
      audience: "participant",
      html:
        "<p>The link in your confirmation email opens your entry's own page, headed <strong>Registration list</strong>. The\nsame link works for the whole trial: through it you pay, accept your place, change your details\nand, if need be, cancel the entry. The calendar's other messages — the place notification, the\nreserve notification and the invitation — each lead to the same page, usually straight to the\npart the message is about.</p>\n<p>The top of the page shows the trial: its dates, venue, organizer, judges, entry period and the\ncontact details the organizer chose to show. Below it are your own status, the dog you entered\nand <strong>Payment details</strong>, which itemizes the price of your entry with the choices you made.</p>\n<h2>Your status at a glance</h2>\n<p>The box on the right says three things: whether you have priority, whether the fee is settled\nand what stage your entry is at.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot6 + "\" alt=\"The status box, with part of the fee still unpaid\" loading=\"lazy\"><figcaption>The status box, with part of the fee still unpaid</figcaption></figure>" +
        "<table>\n<thead>\n<tr>\n<th>Line</th>\n<th>What it can say</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>priority</td>\n<td><em>I have priority</em> or <em>I don't have priority</em> — the grounds for priority are in the trial's details</td>\n</tr>\n<tr>\n<td>payment</td>\n<td><em>I have paid</em>, <em>Test payment is still missing</em>, <em>Payable after confirmation</em> or <em>Waiting for payment processing</em>; when part of the fee is missing, the line names the amount</td>\n</tr>\n<tr>\n<td>stage</td>\n<td><em>Registration received</em>, <em>Your trial place awaits confirmation</em>, <em>I have confirmed my participation</em>, <em>I have confirmed my participation and acknowledged the invitation</em> or <em>I have cancelled my registration</em></td>\n</tr>\n</tbody>\n</table>\n<p>The same facts appear as icons on the dog's row; hover over the icons to see what they mean.</p>\n<h2>Paying</h2>\n<p>When there is something to pay, the payment line has a <strong>PAY</strong> button and\nthe dog's row a euro sign named <em>Pay registration</em>. Both take you to Paytrail's payment\npage. When you return from the payment, the page says <em>Payment received, still confirming it. The status will update shortly.</em>\nand the status updates by itself in a moment.</p>\n<p>The button shows only while something is unpaid. If the trial is paid only once your place is\nconfirmed, the payment line reads <em>Payable after confirmation</em> until then, and the\nbutton appears once you have accepted the place. Something may also become payable later, if the\nsecretary corrects your entry so that its price rises — by removing a membership tick, say. The\nline then names the missing amount and the button comes back.</p>\n<h2>Accepting your place</h2>\n<p>Once the secretary has picked the participants, you get a place notification. Its link opens the\npage and the dialog <strong>Confirm trial place</strong>; the same dialog opens from the status\nbox's <strong>Confirm trial place</strong> button while the stage is\n<em>Your trial place awaits confirmation</em>. Accepting tells the secretary you are taking the place, and\nshows on your row as a tick.</p>\n<p>If payment was set for confirmation, accepting is followed by the dialog\n<strong>Pay and confirm</strong>, whose <strong>Confirm participation</strong> button\ntakes you to pay. The invitation is sent to you only once the place has been paid.</p>\n<h2>Changing your details</h2>\n<p>In the menu at the right end of the dog's row (⋮), <strong>Edit registration</strong> opens the\nsame form you entered with. Changes are saved with <strong>Save changes</strong>. The form\ncan be edited while entry is open; once entry has closed or the trial has started, the details\nare shown but can no longer be changed — changes are then arranged with the secretary. A cancelled\nentry opens under the heading <em>This registration is cancelled</em>.</p>\n<h2>Cancelling the entry</h2>\n<p>Cancel the entry from the row's menu (⋮) with <strong>Cancel registration</strong>. The dialog\nsays which dog's entry to which trial you are cancelling and asks for the reason: the dog in\nseason, the handler or the dog taken ill, another reason, or <em>I don't want to disclose</em>.\nFor an illness, the dialog reminds you that a refund needs a doctor's or a vet's certificate sent\nto the secretary. <strong>Cancel registration</strong> takes effect at once, and the secretary is\ntold.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot7 + "\" alt=\"The reason is picked before confirming\" loading=\"lazy\"><figcaption>The reason is picked before confirming</figcaption></figure>" +
        "<p>On the trial's first day and the day before it, cancelling cannot be done in the calendar; the\ndialog asks you to contact the secretary directly. The refund terms are in the Kennel Club's\nrules, which the link at the foot of the dialog opens.</p>\n<h2>The invitation</h2>\n<p>The invitation arrives by email. Opening its link marks the invitation as read, and the secretary\nsees that. If the invitation carries an attachment, the link opens a page with the trial's and\nthe dog's details and the buttons <strong>Open invitation</strong> and <strong>Download invitation</strong>; if the\norganizer has updated the attachment, the page says when. Without an attachment the link goes\nstraight to your entry's page, where the stage is now\n<em>I have confirmed my participation and acknowledged the invitation</em>.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot8 + "\" alt=\"The invitation's attachment is opened or downloaded\" loading=\"lazy\"><figcaption>The invitation's attachment is opened or downloaded</figcaption></figure>",
      order: 20,
      path: "participant/your-entry",
      title: "Your entry",
    },
    {
      audience: "secretary",
      html:
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot9 + "\" alt=\"A class's entries in their three sections\" loading=\"lazy\"><figcaption>A class's entries in their three sections</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot10 + "\" alt=\"The Event management panel\" loading=\"lazy\"><figcaption>The Event management panel</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot11 + "\" alt=\"Refunding a payment\" loading=\"lazy\"><figcaption>Refunding a payment</figcaption></figure>" +
      ...
      order: 20,
      path: "secretary/while-entry-is-open",
      title: "While entry is open",
    },
    {
      audience: "participant",
      html:
        "<p>The start list is the trial's public page, where the organizer publishes the participants, the\nstart numbers and in the end the results. It needs no login and no link from an email: it opens\nfrom the trial's details in the calendar once the organizer has published the list for at least\none class. Before that the page reads <em>The start list is not available for this event.</em>.</p>\n<h2>What the list shows</h2>\n<p>The list runs day by day and class by class. A class's heading names its judges, and where a day\nis split into a morning and an afternoon, each group is its own section. For every dog and handler\nthe list gives the start number, breed, titles, name, registration number and date of birth, the\nparents, the owner and handler, and the breeder. A withdrawn dog stays in its place marked\n<em>ABSENT</em>, so the numbers do not shift because of a cancellation.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot12 + "\" alt=\"A dog's row, with its result already on it\" loading=\"lazy\"><figcaption>A dog's row, with its result already on it</figcaption></figure>" +
        "<p>The page updates by itself when the organizer publishes more or records a cancellation; there is\nno need to reload it.</p>\n<h2>When the order is final</h2>\n<p>The organizer publishes the list and the start numbers separately, and the class heading says\nwhich stage the class is at:</p>\n<table>\n<thead>\n<tr>\n<th>Note in the heading</th>\n<th>What it means</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td><em>start list is not published yet</em></td>\n<td>the class's participants are not shown yet; the heading is there so the class is known to be coming</td>\n</tr>\n<tr>\n<td><em>start order is not confirmed yet</em></td>\n<td>the participants are in alphabetical order and the number does not yet say when a dog runs</td>\n</tr>\n<tr>\n<td>no note</td>\n<td>the numbers have been drawn and published, and the list is the running order</td>\n</tr>\n</tbody>\n</table>\n<p>In a multi-day trial the numbers can be published one day at a time, so one day's class can be\nfinal while another is still alphabetical.</p>\n<h2>Results</h2>\n<p>Once the organizer has published a class's results, the last line of each dog's row is its\nresult: the class and the prize, AVO1 for example, or a nought or a dash as the rules say. If the\njudge stopped the trial, the result carries the mark <em>Stopped</em> after it.\nResults are published class by class, so the page can show classes with results beside classes\nthat have none yet.</p>\n<p>The results are shown only on the calendar's start list. They reach the Kennel Club's breeding\ndatabase independently of the calendar.</p>\n<p>TODO: The start list's Live section (who is at the post now, how the queue is moving) is switched off in the release (<code>liveViewEnabled</code>); describe it when it is turned on.</p>\n",
      order: 30,
      path: "participant/start-list",
    ...
    },
    {
      ...
      html:
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot9 + "\" alt=\"Participants by group, with the entered dogs below in reserve order\" loading=\"lazy\"><figcaption>Participants by group, with the entered dogs below in reserve order</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot13 + "\" alt=\"Sending a message: template, extra message, contact details and preview\" loading=\"lazy\"><figcaption>Sending a message: template, extra message, contact details and preview</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot14 + "\" alt=\"Invitation delivery by class, the PDF attachment and the invitations still waiting\" loading=\"lazy\"><figcaption>Invitation delivery by class, the PDF attachment and the invitations still waiting</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot15 + "\" alt=\"Start list publishing by class\" loading=\"lazy\"><figcaption>Start list publishing by class</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot16 + "\" alt=\"The secretary's start list\" loading=\"lazy\"><figcaption>The secretary's start list</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot17 + "\" alt=\"Entering the start numbers for a day's and class's dogs\" loading=\"lazy\"><figcaption>Entering the start numbers for a day's and class's dogs</figcaption></figure>" +
        "<p>If the classes have class secretaries of their own, they are given the entry page's links from the\n<strong>Class secretaries' links</strong> tab after the class tabs. The tab has a row for every class of the\ntrial: <strong>Copy link</strong> copies the class's link to the clipboard, and the link works\nwithout signing in and only for that class's numbers. <strong>Revoke links</strong> closes the\nclass's shared links; the next copy gives a new one.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot18 + "\" alt=\"The class secretaries' links are handed out from a tab of their own\" loading=\"lazy\"><figcaption>The class secretaries' links are handed out from a tab of their own</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot19 + "\" alt=\"A two-day class publishes its numbers one day at a time\" loading=\"lazy\"><figcaption>A two-day class publishes its numbers one day at a time</figcaption></figure>" +
        "<p>If a day has morning and afternoon groups, there is a button for each of the two in place of the\nclass's or the day's: the morning's numbers can be published right after its draw, even while the\nafternoon's draw is still to come. On the public start list the afternoon's dogs are then still\nwithout a number. Once both halves are published, the day is published as a whole.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot20 + "\" alt=\"The morning's numbers go out before the afternoon's draw\" loading=\"lazy\"><figcaption>The morning's numbers go out before the afternoon's draw</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot21 + "\" alt=\"The message's recipients are picked class by class\" loading=\"lazy\"><figcaption>The message's recipients are picked class by class</figcaption></figure>",
      order: 30,
      path: "secretary/after-entry-closes",
    ...
    },
    {
      ...
      html:
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot22 + "\" alt=\"Choosing the payment method before going to Paytrail\" loading=\"lazy\"><figcaption>Choosing the payment method before going to Paytrail</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot11 + "\" alt=\"Refunding a payment from the calendar\" loading=\"lazy\"><figcaption>Refunding a payment from the calendar</figcaption></figure>" +
    ...
    },
    {
      audience: "secretary",
      html:
        "<p>On the trial day the secretary's job is to record what the dogs did and to get the results in\nfront of the participants. The <em>Publishing results</em> section of the event page's\n<strong>Event management</strong> panel gathers everything that belongs to it: defining the\nposts, entering the results and publishing them class by class. Saving and publishing are two\ndifferent things — an entered result is visible only in the admin views until the class is\npublished.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot23 + "\" alt=\"Publishing results per class, with the posts and the entry below\" loading=\"lazy\"><figcaption>Publishing results per class, with the posts and the entry below</figcaption></figure>" +
        "<h2>Before the trial starts</h2>\n<p>Check on the event page that the trial has its <em>Kennel Club ID</em>. It is not needed for entering\nresults, but the results page reminds you of a missing id and offers the\n<strong>Fetch Kennel Club ID</strong> button, which fetches the id from the Kennel Club without leaving the\npage.</p>\n<p>The start list needed at the venue opens from the panel's <em>Actions</em> section\nwith <strong>Secretary's start list</strong>. When logged in, the public start list also has\nthe buttons <strong>Copy list</strong>, which copies the list as text for a forum post, say, and\n<strong>Download Excel</strong>, which downloads it as a spreadsheet.</p>\n<p>A class secretary who records their own class's start numbers is given the link described in\n<em>After entry closes</em>. The link opens one class's numbers without a login, and saving says at once\nif a number already belongs to another dog or is not one of the class's.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot24 + "\" alt=\"The class secretary's view of their own class\" loading=\"lazy\"><figcaption>The class secretary's view of their own class</figcaption></figure>" +
        "<h2>Posts</h2>\n<p>In a NOWT trial the dogs go round posts, and the points are recorded post by post. The posts are\ndefined on their own page, opened with the panel's <strong>Configure stations</strong> button; the\nbutton shows only for the event types scored at posts. A course is usually laid out at the venue,\nso the page is separate from the event's details.</p>\n<p>Each trial day gets its own posts with <strong>Add station</strong>, numbered from one within the day.\nFor a post you record <em>Tasks</em> (one or two), <em>Dogs at once</em> and\n<em>Judges</em>, picked from the trial's judges. A post that is not needed is removed\nwith <strong>Remove station</strong>, and the rest are renumbered. <strong>Save</strong> stores the posts in\nthe event's details.</p>\n<h2>Entering results</h2>\n<p>The panel's <strong>Enter results</strong> button becomes active once the trial has\nstarted, and opens the <strong>Results</strong> page. In a multi-day trial the day is picked first,\nand the classes are on their own tabs. The page lists only the dogs picked as participants, in\nrunning order.</p>\n<p><strong>A trial scored at posts (NOWT).</strong> Every task has its own column, and the points go in a field\nunder which the task's maximum shows. Under the field is the judge who judged the task: at a post\nwith one judge the name is just shown, at a post with several it is picked, and the choice carries\nover to the next dog. Zero points need a reason in the <em>Reason for zero</em> field. The result\nis worked out on the row by itself, as the rules say: a single zero rules out a prize, and the\ntotal of the points shows under the row. With <em>Show</em> the page can be narrowed to one\npost, showing only that post's tasks — the result is then left out, since it depends on the other\nposts too.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot25 + "\" alt=\"A NOWT class's points per task, the second dog stopped at post 2\" loading=\"lazy\"><figcaption>A NOWT class's points per task, the second dog stopped at post 2</figcaption></figure>" +
        "<p><strong>Other event types.</strong> The result is the judge's decision and is picked in the\n<em>Result</em> field: a prize of 1 to 3, a nought or a dash, and in NOU and NKM\ntrials only pass or fail. Beside it is <em>Judge</em>, when the class has more than one.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot26 + "\" alt=\"A NOU trial's results: judge, result and interruption\" loading=\"lazy\"><figcaption>A NOU trial's results: judge, result and interruption</figcaption></figure>" +
        "<p><strong>Interruption.</strong> The <em>Interruption</em> field records\n<em>Judge stopped the trial</em>. A stopped dog's result is a nought, as the rules say, and on\nthe published list it carries the mark <em>Stopped</em>. The whole-round view also\nasks <em>Where</em>, that is, at which post the round was stopped. A prize already\nrecorded cannot take a stop beside it; clear the result first.</p>\n<p>On a phone the dogs are listed one under another as cards with the same fields.</p>\n<p><strong>Save results</strong> saves only the rows that changed; <strong>Cancel</strong> discards the changes. If you\nleave the page without saving, the browser warns you. Another secretary's saves reach the page by\nthemselves. If the same dog has meanwhile been recorded differently elsewhere, the save stops at\nthe dialog <strong>Conflicting results</strong>, which shows both versions and asks which one stands;\n<strong>Save choices</strong> saves the choices. The other rows have already been saved by then.</p>\n<h2>Publishing results</h2>\n<p>Results are published class by class with the panel's <strong>Publish results</strong>\nbutton, and the calendar asks for confirmation. Publishing needs the class's start list to be\npublished — otherwise the row reads <em>Publish the start list first</em> — and the\ntrial to have started. A published result shows on the public start list as the last line of the\ndog's row, and corrections saved later show there as they are.\n<strong>Hide results</strong> hides the class's results again.</p>\n<p>Publishing concerns the calendar only: it does not send the results to the Kennel Club.</p>\n<p>TODO: The post's own entry view and the judge's secretary's live entry link are switched off in the release (<code>liveViewEnabled</code>); describe them when they are turned on.</p>\n",
      order: 40,
      path: "secretary/trial-day",
      title: "The trial day and the results",
    },
    {
      audience: "admin",
      html:
        "<p>No accounts are created in the calendar: access is granted to an email address, and its holder\nlogs in either with that address or with a Google account that has the same address. Access is\nalways per club, and the same person can have a role in several clubs.</p>\n<h2>Roles</h2>\n<table>\n<thead>\n<tr>\n<th>Role</th>\n<th>What it allows</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td><em>Secretary</em></td>\n<td>creating and running the club's trials: details, entries, messages, start lists and results</td>\n</tr>\n<tr>\n<td><em>Organization administrator</em></td>\n<td>the same as a secretary, and the club's users' roles besides</td>\n</tr>\n<tr>\n<td><em>Koekalenteri administrator</em></td>\n<td>SNJ's calendar contact: every club's rights, and the maintenance of clubs, event types and message templates</td>\n</tr>\n</tbody>\n</table>\n<p>A club's administrator cannot edit their own roles, and the application administrator's right is\ngranted only by another application administrator.</p>\n<h2>The user list</h2>\n<p><strong>Users</strong> in the admin menu shows the users who have a role in any of the clubs you yourself\nhave access to. With several clubs, the list is narrowed with <em>Organization</em>; the search box\nnarrows by name or address. The icons in the <em>Roles</em> column show administrator status, the\nnumber of club roles, and whether the person is a judge or an official in the Kennel Club's\nregister; the exact list appears when you hover over the icons. The other columns are the contact\ndetails, <em>Kennel Club Email</em>, the kennel district and <em>Last login</em>.</p>\n<h2>Granting access</h2>\n<p>The <strong>Create</strong> button opens the dialog <strong>Add new user role</strong>. It takes\n<em>Organization</em>, <em>Role</em>,\n<em>Email</em> and <em>Name (first name last name)</em>. When the dialog is saved, the\nperson gets the email <em>Access granted</em>, which names the access granted and links to the\ncalendar. If the address already has a user, the new role is added to it.</p>\n<h2>Editing roles</h2>\n<p>Select a user in the list and press <strong>Edit roles</strong> — or double-click the row. The dialog lists\nthe user's clubs with their roles. A role is removed with the row's <strong>Delete</strong> button, and a\nnew one added on the bottom row by picking the club and the role and pressing <strong>Add</strong>. Only\nthe clubs you administer, and in which the user has no role yet, are offered. Changes take effect\nat once, and an added role sends the same email as a new grant.</p>\n<p>The application administrator also sees the <em>Koekalenteri administrator</em> option in the dialog. While it is\nticked, no club roles are listed, because the administrator has them in every club.</p>\n",
      order: 50,
      path: "admin/users",
    ...
    },
    {
      audience: "secretary",
      html:
        "<p>The menu on the left of the admin views holds <strong>Events</strong>, <strong>Judges</strong>, <strong>Officers</strong>,\n<strong>Users</strong> and <strong>Organizer statistics</strong>. On a narrow screen the menu opens from the\nbutton in the header. Judges and officials are directories, from which an event's details pick\nits judges and its chief steward; the secretary reads them, the application's administrator\nmaintains them.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot27 + "\" alt=\"The admin menu\" loading=\"lazy\"><figcaption>The admin menu</figcaption></figure>" +
        "<h2>Judges</h2>\n<p>The directory comes from the Kennel Club's interface, and the search box narrows it by name or\nby any other column. The columns give the judge's number, home town, contact details, kennel\ndistrict and the <em>Event types</em> the judge judges.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot28 + "\" alt=\"The judge directory\" loading=\"lazy\"><figcaption>The judge directory</figcaption></figure>" +
        "<p>Three columns are the calendar's own, not the Kennel Club's:</p>\n<table>\n<thead>\n<tr>\n<th>Column</th>\n<th>What it means</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td><em>Active</em></td>\n<td>the judge can be picked into an event's details; a judge switched off does not appear in the event form's judge list</td>\n</tr>\n<tr>\n<td><em>Mock trial</em></td>\n<td>the judge may judge a Mock trial alone; a NOME-A judge always has the right, a NOWT judge is given it here</td>\n</tr>\n<tr>\n<td><em>Judging languages</em></td>\n<td>the languages the judge judges in</td>\n</tr>\n</tbody>\n</table>\n<p>Only the application's administrator changes these columns. If a judge is missing from the list\nor wrongly marked, tell SNJ's calendar contact.</p>\n<h2>Officials</h2>\n<p>The directory of officials comes from the Kennel Club the same way, with name, id, home town,\ncontact details, kennel district and event types. It is not edited in the calendar. On a narrow\nscreen some of the columns are hidden.</p>\n",
      order: 50,
      path: "secretary/directories",
      title: "Judges and officials",
    },
    {
      audience: "admin",
      html:
        "<p>The calendar works its statistics out from the trials that have ended. They are on three pages:\nthe club's own statistics in the admin menu, the nationwide statistics in the header, and the\napplication administrator's event breakdown. Every chart's title has an i icon that says which\nfigures the chart is drawn from and what has been left out.</p>\n<h2>The club's statistics</h2>\n<p><strong>Organizer statistics</strong> in the admin menu shows the figures of the club you have access\nto; with several clubs, the club is picked under <em>Organization</em>. <em>Year</em> narrows the\ncharts to one year, and only the years in which the club has had trials can be picked.</p>\n<table>\n<thead>\n<tr>\n<th>Chart</th>\n<th>What it says</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td><em>Financial statistics</em></td>\n<td>the amounts paid and refunded, by month</td>\n</tr>\n<tr>\n<td><em>Waiting list and cancellations</em></td>\n<td>entries left on the reserve list and entries cancelled, by month</td>\n</tr>\n<tr>\n<td><em>Member share of starters</em></td>\n<td>how large a share of the participants were the club's members</td>\n</tr>\n<tr>\n<td><em>Judge workload</em></td>\n<td>how many of the club's trials each judge worked at</td>\n</tr>\n</tbody>\n</table>\n<p>The charts at the foot of the page are drawn for the event type and class picked under\n<em>Event type</em> and <em>Class</em>: <em>Starters vs. available places</em>,\n<em>Demand against available places</em> and <em>Cancellation rate</em>. The cancellation rate\nis counted from every entry, those cancelled from the reserve list included.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot29 + "\" alt=\"Participants and places by month for one event type\" loading=\"lazy\"><figcaption>Participants and places by month for one event type</figcaption></figure>" +
        "<h2>Nationwide statistics</h2>\n<p><strong>Statistics</strong> in the header is open to everyone with admin access and gathers every club's\ntrials. Its upper part runs by year: <em>Participation trend</em>, <em>New and returning dog+handler pairs</em>\nand <em>Fill rate</em>. The lower part is drawn for the chosen year: the breakdowns by event type\nand by class, how many times each dog-and-handler pair took part, dogs per handler, and the share\nof entries that got a place, by breed. <em>Breed distribution</em> shows the breeds' shares year\nby year side by side.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot30 + "\" alt=\"New and returning dog-and-handler pairs by year\" loading=\"lazy\"><figcaption>New and returning dog-and-handler pairs by year</figcaption></figure>" +
        "<h2>Event breakdown</h2>\n<p>The application administrator's menu has <strong>Events, places and starts</strong>: a table of the\nchosen year's trials, places, starts, distinct handlers, reserve entries, cancellations and\nmembers' starts, by club and event type, with subtotals.\n<strong>Download Excel</strong> downloads the same table as an Excel file.</p>\n",
      order: 60,
    ...
    },
    {
      audience: "admin",
      html:
        "<p>The application administrator — SNJ's calendar contact — sees a section of their own at the foot\nof the admin menu: <strong>Organizations</strong>, <strong>Event types</strong>, <strong>Email templates</strong> and\n<strong>Events, places and starts</strong>. Clubs are described in the <em>Payments</em> guide and the event\nbreakdown in the <em>Statistics</em> guide; this page covers the other two.</p>\n<h2>Event types</h2>\n<p>The list of event types comes from the Kennel Club's interface, and is refreshed from there with\nthe button above the list. The columns are <em>Abbreviation</em>, <em>Official</em>,\n<em>Active</em> and <em>Description</em> in the chosen language.</p>\n<p><em>Active</em> decides whether the event type is offered in an event's details and in the\nstatistics' pickers. Switch off the Kennel Club's event types that are not held in the calendar,\nso the secretary's list stays short.</p>\n<p>An event type the Kennel Club does not know — an unofficial practice trial, say — can be added\nwith <strong>Add new event type</strong>. The dialog takes <em>Abbreviation</em>, which is\nstored in capitals and has to be new, and a description in Finnish, English and Swedish. The\nadded event type is in use at once and marked unofficial.</p>\n<h2>Message templates</h2>\n<p>The calendar's emails are sent from templates edited on the <strong>Email templates</strong> page. The list\non the left names the messages, and the chosen template opens for editing on two tabs,\n<em>In Finnish</em> and <em>In English</em> — an entrant gets the message in the language they entered in.</p>\n<table>\n<thead>\n<tr>\n<th>Message</th>\n<th>When it is sent</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td><em>Confirmation</em></td>\n<td>when the entry has been received</td>\n</tr>\n<tr>\n<td><em>Receipt</em></td>\n<td>when a payment has succeeded</td>\n</tr>\n<tr>\n<td><em>Payment request</em></td>\n<td>when the secretary sends a payment request, or payment is set for confirmation</td>\n</tr>\n<tr>\n<td><em>Picked notification</em> and <em>Reserve notification</em></td>\n<td>sent by the secretary after picking the participants</td>\n</tr>\n<tr>\n<td><em>Invitation</em></td>\n<td>sent by the secretary, or by itself once a payment arrives</td>\n</tr>\n<tr>\n<td><em>Message to participants</em></td>\n<td>the secretary's free-form message</td>\n</tr>\n<tr>\n<td><em>Refund</em></td>\n<td>after a payment is refunded</td>\n</tr>\n<tr>\n<td><em>Cancel notice (picked)</em>, <em>Cancel notice (reserve)</em> and <em>Cancel notice</em></td>\n<td>when an entrant cancels, according to the entry's stage</td>\n</tr>\n<tr>\n<td><em>Access granted</em></td>\n<td>when a user is given a role</td>\n</tr>\n</tbody>\n</table>\n<p>The templates are in Handlebars form: the message's data is written in double braces, and the\neditor suggests the fields each message has as you type. A field the message does not have is\nunderlined as an error before saving, and so is a block or a brace left open. Ctrl-Shift-M\n(Cmd-Shift-M on a Mac) also lists the findings under the editor. <strong>Save</strong> puts\nthe template into use from the next message on; a template that is not accepted leaves a notice\nabove the buttons naming the language, the line and the reason, and the editor switches to that\nlanguage's tab. <strong>Cancel</strong> restores the saved version.</p>\n",
      order: 70,
  ...
  fi: [
    {
      ...
      html:
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot31 + "\" alt=\"Kalenterin suodattimet ja kaksi koetta, joiden ilmoittautuminen on auki\" loading=\"lazy\"><figcaption>Kalenterin suodattimet ja kaksi koetta, joiden ilmoittautuminen on auki</figcaption></figure>" +
    ...
    },
    {
      ...
      html:
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot34 + "\" alt=\"Tapahtumalistaus ylläpidossa\" loading=\"lazy\"><figcaption>Tapahtumalistaus ylläpidossa</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot35 + "\" alt=\"Kokeen tiedot muokattavana\" loading=\"lazy\"><figcaption>Kokeen tiedot muokattavana</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot36 + "\" alt=\"Kokeen vaiheet tapahtumasivulla\" loading=\"lazy\"><figcaption>Kokeen vaiheet tapahtumasivulla</figcaption></figure>" +
    ...
    },
    {
      audience: "participant",
      html:
        "<p>Vahvistusviestin linkki vie ilmoittautumisesi omalle sivulle, jonka otsikko on <strong>Ilmoittautumistiedot</strong>.\nSama linkki toimii koko kokeen ajan: sen kautta maksat, vahvistat koepaikan, muokkaat tietojasi ja\ntarvittaessa perut ilmoittautumisen. Koekalenterin viestit — koepaikkailmoitus, varasijailmoitus ja\nkoekutsu — vievät kukin samalle sivulle, yleensä suoraan siihen kohtaan, jota viesti koskee.</p>\n<p>Sivun yläreunassa ovat kokeen tiedot: aika, paikka, järjestäjä, tuomarit, ilmoittautumisaika ja\nne yhteystiedot, jotka järjestäjä on halunnut näyttää. Sen alla on oma tilasi, ilmoitettu koira\nja <strong>Maksutiedot</strong>, joka erittelee juuri sinun ilmoittautumisesi hinnan valintoineen.</p>\n<h2>Tilasi yhdellä silmäyksellä</h2>\n<p>Oikean laidan laatikko kertoo kolme asiaa: oletko etusijalla, onko maksu hoidettu ja missä\nvaiheessa ilmoittautumisesi on.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot37 + "\" alt=\"Tilalaatikko, jossa maksusta puuttuu osa\" loading=\"lazy\"><figcaption>Tilalaatikko, jossa maksusta puuttuu osa</figcaption></figure>" +
        "<table>\n<thead>\n<tr>\n<th>Rivi</th>\n<th>Mitä se voi sanoa</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td>etusija</td>\n<td><em>Olen etusijalla</em> tai <em>En ole etusijalla</em> — etusijan perusteet ovat kokeen tiedoissa</td>\n</tr>\n<tr>\n<td>maksu</td>\n<td><em>Olen maksanut</em>, <em>Koemaksu puuttuu vielä</em>, <em>Maksetaan paikan vahvistuttua</em> tai <em>Odottaa maksun käsittelyä</em>; jos maksusta puuttuu osa, rivi kertoo summan</td>\n</tr>\n<tr>\n<td>vaihe</td>\n<td><em>Ilmoittautuminen vastaanotettu</em>, <em>Koepaikkasi odottaa vahvistustasi</em>, <em>Olen vahvistanut osallistumiseni</em>, <em>Olen vahvistanut osallistumiseni ja kuitannut koekutsun</em> tai <em>Olen perunut ilmoittautumiseni</em></td>\n</tr>\n</tbody>\n</table>\n<p>Samat tiedot ovat koiran rivillä kuvakkeina; niiden selitys tulee näkyviin, kun hiiren vie\nkuvakkeiden päälle.</p>\n<h2>Maksaminen</h2>\n<p>Jos maksettavaa on, maksurivin vieressä on painike <strong>MAKSA</strong> ja koiran rivillä\neuromerkki, jonka nimi on <em>Maksa ilmoittautuminen</em>. Kumpikin vie Paytrailin maksusivulle.\nKun palaat maksusta, sivu ilmoittaa <em>Maksu vastaanotettu, vahvistetaan vielä. Tila päivittyy hetken kuluttua.</em> ja tila\npäivittyy itsestään hetken kuluttua.</p>\n<p>Painike näkyy vain silloin, kun jotain on maksamatta. Jos koe maksetaan vasta koepaikan\nvahvistuttua, maksurivillä lukee siihen asti <em>Maksetaan paikan vahvistuttua</em> ja\npainike ilmestyy vasta, kun olet vahvistanut paikan. Maksettavaa voi tulla myös jälkikäteen,\njos koesihteeri korjaa ilmoittautumisen tietoja niin, että hinta nousee — esimerkiksi poistaa\njäsenyysmerkinnän. Silloin rivi kertoo puuttuvan summan ja painike palaa näkyviin.</p>\n<h2>Koepaikan vahvistaminen</h2>\n<p>Kun koesihteeri on valinnut osallistujat, saat koepaikkailmoituksen. Sen linkki avaa sivun ja\nikkunan <strong>Vahvista koepaikka</strong>; sama ikkuna avautuu tilalaatikon painikkeesta\n<strong>Vahvista koepaikka</strong>, kun vaihe on <em>Koepaikkasi odottaa vahvistustasi</em>.\nVahvistus kertoo koesihteerille, että otat paikan vastaan, ja näkyy hänelle rivilläsi väkäsenä.</p>\n<p>Jos maksu on sovittu vasta vahvistuksen yhteyteen, vahvistuksen jälkeen avautuu ikkuna\n<strong>Osallistumismaksun maksaminen ja paikan vahvistaminen</strong>, jonka painike <strong>Maksa ja vahvista</strong>\nvie maksamaan. Koekutsu lähtee sinulle vasta, kun koepaikka on maksettu.</p>\n<h2>Tietojen muokkaaminen</h2>\n<p>Koiran rivin oikean laidan valikosta (⋮) valinta <strong>Muokkaa ilmoittautumista</strong> avaa saman\nlomakkeen, jolla ilmoittauduit. Muutokset tallennetaan painikkeella\n<strong>Tallenna muutokset</strong>. Lomake on muokattavissa ilmoittautumisajan; kun aika on\npäättynyt tai koe on alkanut, tiedot näkyvät mutta niitä ei voi enää muuttaa — silloin muutokset\nhoidetaan koesihteerin kanssa. Peruttu ilmoittautuminen avautuu otsikolla\n<em>Tämä ilmoittautuminen on peruttu</em>.</p>\n<h2>Ilmoittautumisen peruminen</h2>\n<p>Peru ilmoittautuminen rivin valikosta (⋮) valinnalla <strong>Peru ilmoittautuminen</strong>.\nAvautuva ikkuna kertoo, minkä koiran ja minkä kokeen ilmoittautumista olet perumassa, ja pyytää\nperumisen syyn: koiran juoksut, ohjaajan tai koiran sairastuminen, muu syy tai\n<em>En halua kertoa</em>. Sairastapauksessa ikkuna muistuttaa, että maksun\npalautusta varten koesihteerille toimitetaan lääkärin- tai eläinlääkärintodistus.\n<strong>Peru ilmoittautuminen</strong> tulee voimaan heti, ja koesihteeri saa siitä tiedon.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot38 + "\" alt=\"Perumisen syy valitaan ennen vahvistusta\" loading=\"lazy\"><figcaption>Perumisen syy valitaan ennen vahvistusta</figcaption></figure>" +
        "<p>Kokeen alkamispäivänä ja sitä edeltävänä päivänä perumista ei voi tehdä kalenterissa, vaan\nikkuna pyytää ottamaan yhteyttä suoraan koesihteeriin. Palautusehdot ovat Kennelliiton\nsäännöissä; ikkunan alalaidan linkki vie niihin.</p>\n<h2>Koekutsu</h2>\n<p>Koekutsu tulee sähköpostiin. Sen linkin avaaminen kuittaa kutsun luetuksi, ja kuittaus näkyy\nkoesihteerille. Jos kutsun mukana on liitetiedosto, linkki avaa sivun, jolla on kokeen ja koiran\ntiedot sekä painikkeet <strong>Avaa koekutsu</strong> ja <strong>Lataa koekutsu</strong>; jos järjestäjä on\npäivittänyt liitettä, sivu kertoo milloin. Ilman liitettä linkki vie suoraan ilmoittautumisesi\nsivulle, jossa vaihe on nyt <em>Olen vahvistanut osallistumiseni ja kuitannut koekutsun</em>.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot39 + "\" alt=\"Koekutsun liite avataan tai ladataan\" loading=\"lazy\"><figcaption>Koekutsun liite avataan tai ladataan</figcaption></figure>",
      order: 20,
      path: "participant/your-entry",
    ...
    },
    {
      ...
      html:
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot40 + "\" alt=\"Luokan ilmoittautumiset kolmessa osassa\" loading=\"lazy\"><figcaption>Luokan ilmoittautumiset kolmessa osassa</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot41 + "\" alt=\"Tapahtuman hallinta -paneeli\" loading=\"lazy\"><figcaption>Tapahtuman hallinta -paneeli</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot42 + "\" alt=\"Maksun palautus\" loading=\"lazy\"><figcaption>Maksun palautus</figcaption></figure>" +
    ...
    },
    {
      audience: "participant",
      html:
        "<p>Starttilista on kokeen julkinen sivu, jolle järjestäjä julkaisee osallistujat, starttinumerot ja\nlopulta tulokset. Sivu ei vaadi kirjautumista eikä linkkiä sähköpostista: se avautuu kalenterin\nkokeen tiedoista, kun järjestäjä on julkaissut listan vähintään yhdelle luokalle. Sitä ennen\nsivulla lukee <em>Starttilistaa ei ole saatavilla tälle tapahtumalle.</em>.</p>\n<h2>Mitä listalla on</h2>\n<p>Lista etenee päivä ja luokka kerrallaan. Luokan otsikossa ovat luokan tuomarit, ja jos päivä on\njaettu aamu- ja iltapäivään, kumpikin ryhmä on omana osanaan. Jokaisesta koirakosta kerrotaan\nstarttinumero, rotu, tittelit, nimi, rekisterinumero ja syntymäaika, vanhemmat, omistaja ja\nohjaaja sekä kasvattaja. Perunut koirakko näkyy paikallaan merkinnällä <em>POISSA</em>,\njoten numerot eivät siirry peruutuksen takia.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot43 + "\" alt=\"Koirakon rivi, jolla on jo tulos\" loading=\"lazy\"><figcaption>Koirakon rivi, jolla on jo tulos</figcaption></figure>" +
        "<p>Sivu päivittyy itsestään, kun järjestäjä julkaisee lisää tai kirjaa peruutuksen; sitä ei tarvitse\nladata uudelleen.</p>\n<h2>Milloin järjestys on lopullinen</h2>\n<p>Järjestäjä julkaisee listan ja starttinumerot erikseen, ja luokan otsikko kertoo, missä vaiheessa\nluokka on:</p>\n<table>\n<thead>\n<tr>\n<th>Otsikon huomautus</th>\n<th>Mitä se tarkoittaa</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td><em>starttilistaa ei ole vielä julkaistu</em></td>\n<td>luokan osallistujia ei vielä näytetä; otsikko on listalla, jotta luokan tiedetään olevan tulossa</td>\n</tr>\n<tr>\n<td><em>starttijärjestystä ei ole vielä vahvistettu</em></td>\n<td>osallistujat ovat aakkosjärjestyksessä eikä numero vielä kerro starttivuoroa</td>\n</tr>\n<tr>\n<td>ei huomautusta</td>\n<td>numerot on arvottu ja julkaistu, ja lista on koirakoiden starttijärjestys</td>\n</tr>\n</tbody>\n</table>\n<p>Monipäiväisessä kokeessa numerot voi julkaista päivä kerrallaan, joten yhden päivän luokka voi olla\nlopullinen toisen ollessa vielä aakkosjärjestyksessä.</p>\n<h2>Tulokset</h2>\n<p>Kun järjestäjä on julkaissut luokan tulokset, jokaisen koirakon rivin viimeinen rivi on sen\ntulos: luokka ja palkintosija, esimerkiksi AVO1, tai nolla ja viiva sääntöjen mukaan. Jos tuomari\nkeskeytti kokeen, tuloksen perässä on merkintä <em>Kesk.</em>. Tulokset\njulkaistaan luokittain, joten sivulla voi olla luokkia, joiden tulokset ovat jo näkyvissä, ja\nluokkia, joilla ei vielä ole niitä.</p>\n<p>Tulokset näkyvät vain Koekalenterin starttilistalla. Kennelliiton jalostustietojärjestelmään ne\nkirjataan Koekalenterista riippumatta.</p>\n<p>TODO: Starttilistan Live-osio (rastilla nyt, jonon eteneminen) on julkaisusta pois kytkettynä (<code>liveViewEnabled</code>); kuvataan, kun se otetaan käyttöön.</p>\n",
      order: 30,
      path: "participant/start-list",
    ...
    },
    {
      ...
      html:
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot40 + "\" alt=\"Osallistujat ryhmittäin, ilmoittautuneet alla varasijajärjestyksessä\" loading=\"lazy\"><figcaption>Osallistujat ryhmittäin, ilmoittautuneet alla varasijajärjestyksessä</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot44 + "\" alt=\"Viestin lähettäminen: pohja, lisäviesti, yhteystiedot ja esikatselu\" loading=\"lazy\"><figcaption>Viestin lähettäminen: pohja, lisäviesti, yhteystiedot ja esikatselu</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot45 + "\" alt=\"Koekutsun lähetys luokittain, PDF-liite ja odottavat kutsut\" loading=\"lazy\"><figcaption>Koekutsun lähetys luokittain, PDF-liite ja odottavat kutsut</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot46 + "\" alt=\"Starttilistan julkaisu luokittain\" loading=\"lazy\"><figcaption>Starttilistan julkaisu luokittain</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot47 + "\" alt=\"Sihteerin starttilista\" loading=\"lazy\"><figcaption>Sihteerin starttilista</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot48 + "\" alt=\"Starttinumeroiden syöttö päivän ja luokan koirakoille\" loading=\"lazy\"><figcaption>Starttinumeroiden syöttö päivän ja luokan koirakoille</figcaption></figure>" +
        "<p>Jos luokilla on omat luokkasihteerit, heille jaetaan syöttösivun linkit välilehdeltä\n<strong>Luokkasihteerien linkit</strong>, joka on luokkien välilehtien perässä. Välilehdellä on rivi jokaiselle\nkokeen luokalle: <strong>Kopioi linkki</strong> kopioi luokan linkin leikepöydälle, ja linkki toimii\nilman kirjautumista ja vain sen luokan numeroihin. <strong>Mitätöi linkit</strong> sulkee luokan\njaetut linkit; seuraava kopiointi antaa uuden.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot49 + "\" alt=\"Luokkasihteerien linkit jaetaan omalta välilehdeltään\" loading=\"lazy\"><figcaption>Luokkasihteerien linkit jaetaan omalta välilehdeltään</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot50 + "\" alt=\"Kahden päivän luokan numerot julkaistaan päivä kerrallaan\" loading=\"lazy\"><figcaption>Kahden päivän luokan numerot julkaistaan päivä kerrallaan</figcaption></figure>" +
        "<p>Jos päivällä on aamupäivän ja iltapäivän ryhmät, luokan tai päivän painikkeen sijasta on painike\nkummallekin vuorolle: aamupäivän numerot voi julkaista heti sen arvonnan jälkeen, vaikka iltapäivän\narvonta olisi vielä tekemättä. Julkisella starttilistalla iltapäivän koirakot ovat silloin vielä\nilman numeroa. Kun molemmat vuorot on julkaistu, päivä on julkaistu kokonaan.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot51 + "\" alt=\"Aamupäivän numerot julkaistaan ennen iltapäivän arvontaa\" loading=\"lazy\"><figcaption>Aamupäivän numerot julkaistaan ennen iltapäivän arvontaa</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot52 + "\" alt=\"Viestin vastaanottajat valitaan luokittain\" loading=\"lazy\"><figcaption>Viestin vastaanottajat valitaan luokittain</figcaption></figure>",
      order: 30,
      path: "secretary/after-entry-closes",
    ...
    },
    {
      ...
      html:
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot53 + "\" alt=\"Maksutavan valinta ennen siirtymistä Paytrailiin\" loading=\"lazy\"><figcaption>Maksutavan valinta ennen siirtymistä Paytrailiin</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot42 + "\" alt=\"Maksun palautus koekalenterista\" loading=\"lazy\"><figcaption>Maksun palautus koekalenterista</figcaption></figure>" +
    ...
    },
    {
      audience: "secretary",
      html:
        "<p>Koepäivänä koesihteerin työ on kirjata, mitä koirakot tekivät, ja saada tulokset osallistujien\nnähtäville. Tapahtumasivun <strong>Tapahtuman hallinta</strong> -paneelin osio\n<em>Tulosten julkaisu</em> kokoaa kaiken tähän kuuluvan: rastien määrittelyn,\ntulosten syötön ja luokittaisen julkaisun. Tallentaminen ja julkaiseminen ovat kaksi eri asiaa —\nsyötetty tulos näkyy vain ylläpidossa, kunnes luokka julkaistaan.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot54 + "\" alt=\"Tulosten julkaisu luokittain, alla rastit ja tulosten syöttö\" loading=\"lazy\"><figcaption>Tulosten julkaisu luokittain, alla rastit ja tulosten syöttö</figcaption></figure>" +
        "<h2>Ennen kokeen alkua</h2>\n<p>Tarkista tapahtumasivulta, että kokeella on <em>Kennelliiton koetunnus</em>. Sitä ei tarvita tulosten\nsyöttämiseen, mutta tulossivu muistuttaa puuttuvasta tunnuksesta ja tarjoaa painikkeen\n<strong>Hae koetunnus</strong>, jolla tunnuksen voi hakea Kennelliitosta poistumatta sivulta.</p>\n<p>Koepaikalla tarvittava starttilista avautuu paneelin <em>Toiminnot</em>-osion\npainikkeella <strong>Sihteerin starttilista</strong>. Kirjautuneena myös julkisella\nstarttilistalla on painikkeet <strong>Kopioi lista</strong>, joka kopioi listan tekstinä esimerkiksi\nfoorumille, ja <strong>Lataa Excel</strong>, joka lataa sen taulukkona.</p>\n<p>Luokkasihteerille, joka kirjaa oman luokkansa starttinumerot, annetaan\n<em>Ilmoittautumisajan jälkeen</em> -ohjeen mukainen linkki. Linkki avaa yhden luokan numerot ilman\nkirjautumista, ja tallennus kertoo heti, jos numero on jo toisella koiralla tai ei kuulu luokalle.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot55 + "\" alt=\"Luokkasihteerin näkymä omaan luokkaansa\" loading=\"lazy\"><figcaption>Luokkasihteerin näkymä omaan luokkaansa</figcaption></figure>" +
        "<h2>Rastit</h2>\n<p>NOWT-kokeessa koirakot kiertävät rasteja, ja pisteet kirjataan rasteittain. Rastit määritellään\nomalla sivullaan, jonka paneelin painike <strong>Määritä rastit</strong> avaa; painike näkyy vain\nniissä koemuodoissa, joissa pisteytys tehdään rasteilla. Rata rakennetaan yleensä vasta\nkoepaikalla, joten sivu on erillään kokeen tiedoista.</p>\n<p>Jokaiselle koepäivälle lisätään omat rastinsa painikkeella <strong>Lisää rasti</strong>, ja ne\nnumeroidaan päivän sisällä yhdestä alkaen. Rastista kirjataan <em>Tehtäviä</em> (yksi tai\nkaksi), <em>Koiria kerralla</em> ja <em>Tuomarit</em>, jotka valitaan kokeen\ntuomareista. Tarpeeton rasti poistetaan painikkeella <strong>Poista rasti</strong>, ja loput\nnumeroituvat uudelleen. <strong>Tallenna</strong> tallentaa rastit kokeen tietoihin.</p>\n<h2>Tulosten syöttö</h2>\n<p>Paneelin painike <strong>Syötä tulokset</strong> aktivoituu, kun koe on alkanut, ja avaa\nsivun <strong>Tulokset</strong>. Monipäiväisessä kokeessa valitaan ensin päivä, ja luokat ovat omilla\nvälilehdillään. Sivulla ovat vain osallistujiksi nostetut koirakot starttijärjestyksessä.</p>\n<p><strong>Rasteilla pisteytettävä koe (NOWT).</strong> Jokaisella tehtävällä on oma sarakkeensa, ja pisteet\nkirjoitetaan kenttään, jonka alla näkyy tehtävän enimmäispistemäärä. Kentän alla on tehtävää\narvostellut tuomari: yhden tuomarin rastilla nimi vain näytetään, useamman tuomarin rastilla\nse valitaan ja valinta siirtyy seuraavalle koirakolle. Nolla pistettä vaatii syyn kenttään\n<em>Nollan syy</em>. Tulos lasketaan riville itsestään sääntöjen mukaan: yksikin nolla\nestää palkintosijan, ja rivin alla näkyy pisteiden summa. Valinnalla <em>Näytä</em> sivun\nvoi rajata yhteen rastiin, jolloin näkyvissä ovat vain sen rastin tehtävät — tulos jää silloin\npois, koska se riippuu muistakin rasteista.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot56 + "\" alt=\"NOWT-luokan pisteet tehtävittäin, toinen koirakko keskeytetty rastilla 2\" loading=\"lazy\"><figcaption>NOWT-luokan pisteet tehtävittäin, toinen koirakko keskeytetty rastilla 2</figcaption></figure>" +
        "<p><strong>Muut koemuodot.</strong> Tulos on tuomarin päätös ja se valitaan kentästä <em>Tulos</em>:\npalkintosija 1–3, nolla tai viiva, NOU- ja NKM-kokeessa vain hyväksytty tai hylätty. Vieressä on\n<em>Tuomari</em>, jos luokalla on useampi tuomari.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot57 + "\" alt=\"NOU-kokeen tulokset: tuomari, tulos ja keskeytys\" loading=\"lazy\"><figcaption>NOU-kokeen tulokset: tuomari, tulos ja keskeytys</figcaption></figure>" +
        "<p><strong>Keskeytys.</strong> Kentästä <em>Keskeytys</em> kirjataan\n<em>Tuomari keskeytti kokeen</em>. Keskeytetyn koirakon tulos on sääntöjen mukaan nolla, ja\njulkaistulla listalla sen perässä on merkintä <em>Kesk.</em>. Koko kierroksen\nnäkymässä kysytään lisäksi <em>Missä</em>, eli millä rastilla keskeytys tapahtui. Jo\nkirjattu palkintosija ei voi saada keskeytystä rinnalleen; poista ensin tulos.</p>\n<p>Puhelimella koirakot ovat allekkain omina kortteinaan samoilla kentillä.</p>\n<p><strong>Tallenna tulokset</strong> tallentaa vain muuttuneet rivit; <strong>Peruuta</strong> hylkää muutokset. Jos sivulta\npoistuu tallentamatta, selain varoittaa. Toisen koesihteerin tallennukset päivittyvät sivulle\nitsestään. Jos sama koirakko on ehditty kirjata muualla toisin, tallennus pysähtyy ikkunaan\n<strong>Ristiriitaiset tulokset</strong>, joka näyttää molemmat versiot ja kysyy, kumpi jää voimaan;\n<strong>Tallenna valinnat</strong> tallentaa valinnat. Muut rivit on tallennettu jo silloin.</p>\n<h2>Tulosten julkaisu</h2>\n<p>Tulokset julkaistaan luokittain paneelin painikkeella <strong>Julkaise tulokset</strong>, ja\nkalenteri pyytää vahvistuksen. Julkaisu edellyttää, että luokan starttilista on julkaistu — muuten\nrivillä lukee <em>Julkaise ensin starttilista</em> — ja että koe on alkanut. Julkaistu\ntulos näkyy julkisella starttilistalla koirakon rivin viimeisenä rivinä, ja myöhemmin tallennetut\nkorjaukset näkyvät siellä sellaisinaan. <strong>Piilota tulokset</strong> piilottaa\nluokan tulokset uudelleen.</p>\n<p>Julkaisu koskee vain Koekalenteria: se ei lähetä tuloksia Kennelliittoon.</p>\n<p>TODO: Rastin oma kirjausnäkymä ja tuomarin sihteerin live-kirjauslinkki ovat julkaisusta pois kytkettyinä (<code>liveViewEnabled</code>); kuvataan, kun ne otetaan käyttöön.</p>\n",
      order: 40,
      path: "secretary/trial-day",
    ...
    },
    {
      audience: "admin",
      html:
        "<p>Koekalenteriin ei luoda tunnuksia: käyttöoikeus annetaan sähköpostiosoitteelle, ja sen haltija\nkirjautuu joko sillä osoitteella tai Google-tilillä, jonka osoite on sama. Oikeus on aina\nyhdistyskohtainen, ja samalla henkilöllä voi olla rooli useassa yhdistyksessä.</p>\n<h2>Roolit</h2>\n<table>\n<thead>\n<tr>\n<th>Rooli</th>\n<th>Mitä sillä voi tehdä</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td><em>Koesihteeri</em></td>\n<td>yhdistyksen kokeiden luonti ja hoito: tiedot, ilmoittautumiset, viestit, starttilistat ja tulokset</td>\n</tr>\n<tr>\n<td><em>Yhdistyksen pääkäyttäjä</em></td>\n<td>sama kuin koesihteeri, ja lisäksi yhdistyksen käyttäjien roolit</td>\n</tr>\n<tr>\n<td><em>Koekalenterin pääkäyttäjä</em></td>\n<td>SNJ:n koekalenterivastaava: kaikkien yhdistysten oikeudet sekä yhdistysten, tapahtumatyyppien ja viestipohjien ylläpito</td>\n</tr>\n</tbody>\n</table>\n<p>Yhdistyksen pääkäyttäjä ei voi muokata omia roolejaan, ja koekalenterin pääkäyttäjän oikeuden\nantaa vain toinen koekalenterin pääkäyttäjä.</p>\n<h2>Käyttäjälistaus</h2>\n<p>Ylläpidon valikon <strong>Käyttäjät</strong> näyttää ne käyttäjät, joilla on rooli johonkin niistä yhdistyksistä,\njoihin sinulla itselläsi on oikeus. Jos yhdistyksiä on useita, listaa rajataan valinnalla\n<em>Yhdistys</em>; hakukenttä rajaa nimen tai osoitteen mukaan. <em>Roolit</em>-sarakkeen\nkuvakkeet kertovat pääkäyttäjyyden, yhdistysroolien määrän sekä sen, onko henkilö Kennelliiton\nrekisterissä tuomari tai koetoimitsija; tarkka luettelo tulee näkyviin, kun hiiren vie kuvakkeiden\npäälle. Muut sarakkeet ovat yhteystiedot, <em>Kennelliiton sähköposti</em>, kennelpiiri ja\n<em>Viimeinen kirjautuminen</em>.</p>\n<h2>Oikeuden antaminen</h2>\n<p>Painike <strong>Lisää uusi</strong> avaa ikkunan <strong>Lisää uusi käyttäjärooli</strong>. Siihen kirjataan\n<em>Yhdistys</em>, <em>Rooli</em>,\n<em>Sähköposti</em> ja <em>Nimi (etunimi sukunimi)</em>. Kun ikkuna tallennetaan, henkilö\nsaa sähköpostiin viestin <em>Lisätty käyttäjäoikeus</em>, jossa kerrotaan annettu oikeus ja linkki\nKoekalenteriin. Jos osoitteella on jo käyttäjä, uusi rooli lisätään sille.</p>\n<h2>Roolien muokkaaminen</h2>\n<p>Valitse käyttäjä listasta ja paina <strong>Muokkaa rooleja</strong> — tai tuplaklikkaa riviä. Ikkuna luettelee\nkäyttäjän yhdistykset rooleineen. Rooli poistetaan rivin painikkeella <strong>Poista</strong>, ja uusi\nlisätään alimmalla rivillä valitsemalla yhdistys ja rooli ja painamalla <strong>Lisää</strong>. Tarjolla\novat vain ne yhdistykset, joihin sinulla on pääkäyttäjän oikeus ja joihin käyttäjällä ei vielä ole\nroolia. Muutokset tulevat voimaan heti, ja lisätystä roolista lähtee sama sähköposti kuin uudesta\noikeudesta.</p>\n<p>Koekalenterin pääkäyttäjä näkee ikkunassa lisäksi valinnan <em>Koekalenterin pääkäyttäjä</em>. Kun se on valittu,\nyhdistyskohtaisia rooleja ei luetella, koska pääkäyttäjällä on ne kaikkiin yhdistyksiin.</p>\n",
      order: 50,
      path: "admin/users",
    ...
    },
    {
      audience: "secretary",
      html:
        "<p>Ylläpidon vasemman laidan valikossa ovat <strong>Tapahtumat</strong>, <strong>Tuomarit</strong>, <strong>Koetoimitsijat</strong>,\n<strong>Käyttäjät</strong> ja <strong>Järjestäjän tilastot</strong>. Kapealla näytöllä valikko avautuu yläpalkin\npainikkeesta. Tuomarit ja koetoimitsijat ovat luetteloita, joista kokeen tiedot poimivat\ntuomarinsa ja vastaavan koetoimitsijansa; koesihteeri lukee niitä, koekalenterin pääkäyttäjä\nylläpitää.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot58 + "\" alt=\"Ylläpidon valikko\" loading=\"lazy\"><figcaption>Ylläpidon valikko</figcaption></figure>" +
        "<h2>Tuomarit</h2>\n<p>Luettelo tulee Kennelliiton rajapinnasta, ja hakukenttä rajaa sitä nimen tai muun sarakkeen\nmukaan. Sarakkeet kertovat tuomarin numeron, kotikunnan, yhteystiedot, kennelpiirin ja\n<em>Tapahtumatyypit</em>, joita tuomari arvostelee.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot59 + "\" alt=\"Tuomariluettelo\" loading=\"lazy\"><figcaption>Tuomariluettelo</figcaption></figure>" +
        "<p>Kolme saraketta ovat Koekalenterin omia, eivät Kennelliiton:</p>\n<table>\n<thead>\n<tr>\n<th>Sarake</th>\n<th>Mitä se tarkoittaa</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td><em>Arvostelee</em></td>\n<td>tuomari on valittavissa kokeen tietoihin; pois kytketty tuomari ei näy kokeen lomakkeen tuomarilistassa</td>\n</tr>\n<tr>\n<td><em>Mock trial</em></td>\n<td>tuomari saa arvostella Mock trialin yksin; NOME-A-tuomarilla oikeus on aina, NOWT-tuomarille se annetaan tästä</td>\n</tr>\n<tr>\n<td><em>Arvostelukielet</em></td>\n<td>kielet, joilla tuomari arvostelee</td>\n</tr>\n</tbody>\n</table>\n<p>Sarakkeita muuttaa vain koekalenterin pääkäyttäjä. Jos tuomari puuttuu listalta tai on väärin\nmerkitty, ilmoita asiasta SNJ:n koekalenterivastaavalle.</p>\n<h2>Koetoimitsijat</h2>\n<p>Koetoimitsijoiden luettelo tulee samoin Kennelliitosta, ja siinä ovat nimi, tunnus, kotikunta,\nyhteystiedot, kennelpiiri ja koemuodot. Sitä ei muokata Koekalenterissa. Kapealla näytöllä osa\nsarakkeista on piilossa.</p>\n",
      order: 50,
      path: "secretary/directories",
    ...
    },
    {
      audience: "admin",
      html:
        "<p>Koekalenteri laskee tilastot päättyneistä kokeista itse. Niitä on kolmella sivulla: yhdistyksen\nomat tilastot ylläpidon valikossa, koko maan tilastot yläpalkissa ja koekalenterin pääkäyttäjän\ntapahtumaerittely. Jokaisen kaavion otsikossa on i-kuvake, joka kertoo, mistä luvuista kaavio on\nlaskettu ja mitä siitä on jätetty pois.</p>\n<h2>Yhdistyksen tilastot</h2>\n<p>Ylläpidon valikon <strong>Järjestäjän tilastot</strong> näyttää sen yhdistyksen luvut, johon sinulla\non oikeus; jos yhdistyksiä on useita, ne valitaan kohdasta <em>Yhdistys</em>. <em>Vuosi</em>\nrajaa kaaviot yhteen vuoteen, ja valittavissa ovat vain ne vuodet, joina yhdistyksellä on ollut\nkokeita.</p>\n<table>\n<thead>\n<tr>\n<th>Kaavio</th>\n<th>Mitä se kertoo</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td><em>Talouden tilastot</em></td>\n<td>maksetut ja palautetut summat kuukausittain</td>\n</tr>\n<tr>\n<td><em>Varasijalle jääneet ja peruutukset</em></td>\n<td>varasijalle jääneet ja perutut ilmoittautumiset kuukausittain</td>\n</tr>\n<tr>\n<td><em>Jäsenten osuus osallistujista</em></td>\n<td>kuinka suuri osa osallistujista oli yhdistyksen jäseniä</td>\n</tr>\n<tr>\n<td><em>Tuomarien työmäärä</em></td>\n<td>monessako yhdistyksen kokeessa kukin tuomari toimi</td>\n</tr>\n</tbody>\n</table>\n<p>Sivun alaosan kaaviot lasketaan koemuodolle ja luokalle, jotka valitaan kohdista\n<em>Koemuoto</em> ja <em>Luokka</em>: <em>Osallistujamäärä suhteessa paikkoihin</em>,\n<em>Kysyntä suhteessa paikkoihin</em> ja <em>Peruutusprosentti</em>. Peruutusprosentti\nlasketaan kaikista ilmoittautuneista, myös varasijalta peruneista.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot60 + "\" alt=\"Osallistujat ja paikat kuukausittain yhdelle koemuodolle\" loading=\"lazy\"><figcaption>Osallistujat ja paikat kuukausittain yhdelle koemuodolle</figcaption></figure>" +
        "<h2>Koko maan tilastot</h2>\n<p>Yläpalkin <strong>Tilastot</strong> on jokaisen ylläpito-oikeuden haltijan nähtävissä ja kokoaa kaikkien\nyhdistysten kokeet. Sen yläosa kulkee vuosittain: <em>Osallistumisen kehitys</em>,\n<em>Uudet ja palaavat koirakot</em> ja <em>Täyttöaste</em>. Alaosa lasketaan valitulle vuodelle:\njakaumat koemuodoittain ja luokittain, koira–ohjaaja-parien osallistumiskerrat, koirien määrä\nohjaajaa kohden ja osallistujaprosentti roduittain. <em>Rotujakauma</em> näyttää rotujen\nosuudet vuosittain vierekkäin.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot61 + "\" alt=\"Uudet ja palaavat koirakot vuosittain\" loading=\"lazy\"><figcaption>Uudet ja palaavat koirakot vuosittain</figcaption></figure>" +
        "<h2>Tapahtumaerittely</h2>\n<p>Koekalenterin pääkäyttäjän valikossa on <strong>Tapahtumat, paikat ja startit</strong>: taulukko, jossa\novat valitun vuoden kokeet, starttipaikat, startit, eri ohjaajat, varasijalle jääneet, peruutukset\nja jäsenten startit yhdistyksittäin ja koemuodoittain, välisummineen. <strong>Lataa Excel</strong>\nlataa saman taulukon Excel-tiedostona.</p>\n",
      order: 60,
      path: "admin/statistics",
      title: "Tilastot",
    },
    {
      audience: "admin",
      html:
        "<p>Koekalenterin pääkäyttäjä — SNJ:n koekalenterivastaava — näkee ylläpidon valikon alaosassa\noman osionsa: <strong>Yhdistykset</strong>, <strong>Tapahtumatyypit</strong>, <strong>Viestipohjat</strong> ja\n<strong>Tapahtumat, paikat ja startit</strong>. Yhdistykset on kuvattu <em>Maksuliikenne</em>-ohjeessa ja\ntapahtumaerittely <em>Tilastot</em>-ohjeessa; tämä sivu kertoo kahdesta muusta.</p>\n<h2>Tapahtumatyypit</h2>\n<p>Luettelo koemuodoista tulee Kennelliiton rajapinnasta, ja se päivitetään sieltä listan\nyläpuolen painikkeella. Sarakkeet ovat <em>Lyhenne</em>, <em>Virallinen</em>, <em>Käytössä</em>\nja <em>Kuvaus</em> valitulla kielellä.</p>\n<p><em>Käytössä</em> ratkaisee, tarjotaanko koemuotoa kokeen tiedoissa ja tilastojen valinnoissa. Kytke\npois ne Kennelliiton koemuodot, joita Koekalenterissa ei järjestetä, niin koesihteerin lista\npysyy lyhyenä.</p>\n<p>Koemuodon, jota Kennelliitto ei tunne — esimerkiksi epävirallisen harjoituskokeen — voi lisätä\npainikkeella <strong>Lisää uusi tapahtumatyyppi</strong>. Ikkunaan kirjataan <em>Lyhenne</em>,\njoka tallentuu isoin kirjaimin ja jonka on oltava uusi, sekä kuvaus suomeksi, englanniksi ja\nruotsiksi. Lisätty koemuoto on heti käytössä ja merkitty epäviralliseksi.</p>\n<h2>Viestipohjat</h2>\n<p>Koekalenterin sähköpostit lähtevät pohjista, joita muokataan sivulla <strong>Viestipohjat</strong>.\nVasemman laidan lista nimeää viestit, ja valittu pohja avautuu muokattavaksi kahdella\nvälilehdellä, <em>Suomeksi</em> ja <em>In English</em> — ilmoittautuja saa viestin sillä kielellä,\njolla hän ilmoittautui.</p>\n<table>\n<thead>\n<tr>\n<th>Viesti</th>\n<th>Milloin se lähtee</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td><em>Vahvistusviesti</em></td>\n<td>kun ilmoittautuminen on vastaanotettu</td>\n</tr>\n<tr>\n<td><em>Kuitti</em></td>\n<td>maksun onnistuttua</td>\n</tr>\n<tr>\n<td><em>Maksupyyntö</em></td>\n<td>kun koesihteeri lähettää maksupyynnön tai maksu on sovittu vahvistuksen yhteyteen</td>\n</tr>\n<tr>\n<td><em>Koepaikkailmoitus</em> ja <em>Varasijailmoitus</em></td>\n<td>koesihteerin lähettäminä osallistujien valinnan jälkeen</td>\n</tr>\n<tr>\n<td><em>Koekutsu</em></td>\n<td>koesihteerin lähettämänä, tai itsestään maksun tultua</td>\n</tr>\n<tr>\n<td><em>Viesti osallistujille</em></td>\n<td>koesihteerin vapaamuotoinen viesti</td>\n</tr>\n<tr>\n<td><em>Maksun palautus</em></td>\n<td>maksun palautuksen jälkeen</td>\n</tr>\n<tr>\n<td><em>Peruutusilmoitus koepaikalta</em>, <em>Peruutusilmoitus sihteerille: varasija</em> ja <em>Peruutusilmoitus sihteerille: ennen varasijailmoitusta</em></td>\n<td>ilmoittautujan peruttua, ilmoittautumisen vaiheen mukaan</td>\n</tr>\n<tr>\n<td><em>Lisätty käyttäjäoikeus</em></td>\n<td>kun käyttäjälle annetaan rooli</td>\n</tr>\n</tbody>\n</table>\n<p>Pohjat ovat Handlebars-muotoa: viestin tiedot kirjoitetaan kaksoisaaltosulkeisiin, ja editori\nehdottaa kunkin viestin käytettävissä olevia kenttiä sitä mukaa kuin kirjoitat. Kenttä, jota\nviestillä ei ole, alleviivataan virheeksi ennen tallennusta, samoin sulkematta jäänyt lohko tai\naaltosulje. Löydökset saa myös luettelona editorin alle näppäimillä Ctrl-Shift-M (Macissa\nCmd-Shift-M). <strong>Tallenna</strong> ottaa pohjan käyttöön heti seuraavasta viestistä alkaen; jos pohja ei\nkelpaa, painikkeiden yläpuolelle tulee ilmoitus, joka kertoo kielen, rivin ja syyn, ja editori\nvaihtaa sen kielen välilehdelle. <strong>Peruuta</strong> palauttaa tallennetun version.</p>\n",
      order: 70,
      path: "admin/application",
