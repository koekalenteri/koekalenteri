...
import shot15 from "../../pages/admin/eventViewPage/infoPanel/__screenshots__/StartNumbersPublishing.visual.test.tsx/start-numbers-publishing-half-day-chromium-linux.png"
import shot16 from "../../pages/admin/eventViewPage/__screenshots__/MessageRecipientsDialog.visual.test.tsx/message-recipients-chromium-linux.png"
import shot17 from "../../pages/__screenshots__/PaymentPage.visual.test.tsx/payment-page-methods-desktop-chromium-linux.png"
  ...
  en: [
    ...
    },
    {
      ...
      html:
        ...
        "<p>If the morning and the afternoon of a day are drawn separately, each has a button of its own beside\nthe class's or the day's: the morning's numbers can be published right after its draw, even while\nthe afternoon's draw is still to come. On the public start list the afternoon's dogs are then still\nwithout a number. Once both halves are published, the day is published as a whole.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot15 + "\" alt=\"The morning's numbers go out before the afternoon's draw\" loading=\"lazy\"><figcaption>The morning's numbers go out before the afternoon's draw</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot16 + "\" alt=\"The message's recipients are picked class by class\" loading=\"lazy\"><figcaption>The message's recipients are picked class by class</figcaption></figure>",
      order: 30,
    ...
    },
    {
      ...
      html:
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot17 + "\" alt=\"Choosing the payment method before going to Paytrail\" loading=\"lazy\"><figcaption>Choosing the payment method before going to Paytrail</figcaption></figure>" +
    ...
    },
    {
      ...
      html:
        ...
        "<p>Jos päivän aamupäivä ja iltapäivä arvotaan erikseen, kummallakin on oma painikkeensa luokan tai\npäivän painikkeen vieressä: aamupäivän numerot voi julkaista heti sen arvonnan jälkeen, vaikka\niltapäivän arvonta olisi vielä tekemättä. Julkisella starttilistalla iltapäivän koirakot ovat\nsilloin vielä ilman numeroa. Kun molemmat puoliskot on julkaistu, päivä on julkaistu kokonaan.</p>\n" +
        "<figure class=\"guide-shot\"><img src=\"" + shot15 + "\" alt=\"Aamupäivän numerot julkaistaan ennen iltapäivän arvontaa\" loading=\"lazy\"><figcaption>Aamupäivän numerot julkaistaan ennen iltapäivän arvontaa</figcaption></figure>" +
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot16 + "\" alt=\"Viestin vastaanottajat valitaan luokittain\" loading=\"lazy\"><figcaption>Viestin vastaanottajat valitaan luokittain</figcaption></figure>",
      order: 30,
      path: "koesihteerille/ilmoajan-jalkeen",
    ...
    },
    {
      ...
      html:
        ...
        "<figure class=\"guide-shot\"><img src=\"" + shot17 + "\" alt=\"Maksutavan valinta ennen siirtymistä Paytrailiin\" loading=\"lazy\"><figcaption>Maksutavan valinta ennen siirtymistä Paytrailiin</figcaption></figure>" +
