      ...
      json: [
        {
          ...
          rajoitukset: [{ lisätieto: 'Etusija järjestävän yhdistyksen jäsenillä', tyyppi: 'Etusija' }],
          tapahtuma: '',
          tarkenne: '',
      ...
      200,
      {
        choices: [
          expect.objectContaining({
            ...
            cost: 55,
            description:
              'Osallistumismaksu sisältää keittolounaan.\n\nEtusija: Etusija järjestävän yhdistyksen jäsenillä',
