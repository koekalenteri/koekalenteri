import { formatISO, isSameDay, isSameMonth, isSameYear, isValid, lightFormat, parseISO } from "date-fns"
...
export const currentFinnishTime = (): string => formatISO(utcToZonedTime(new Date(), 'Europe/Helsinki'))
