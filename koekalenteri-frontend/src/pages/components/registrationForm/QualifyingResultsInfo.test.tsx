...
describe('QualifyingResultsInfo', () => {
  ...
  it('should render a NOME-B ALO registraton', () => {
    ...
    const requirements = getRequirements(reg.eventType, reg.class as RegistrationClass, reg.dates && reg.dates.length ? reg.dates[0].date : new Date())
    const { container } = render(<QualifyingResultsInfo
      regNo={reg.dog.regNo}
